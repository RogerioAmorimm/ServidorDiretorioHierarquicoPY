...
if __name__ == "__main__":
  ...
  conn_serverDepVenda.root.exposed_registraServer('HourServer',ipAdress,PORT_HOURSERVER)
  print(f"Registrando no Server de diretório DepartamentoRH") 
  conn_serverDepRH.root.exposed_registraServer('HourServer',ipAdress,PORT_HOURSERVER)
